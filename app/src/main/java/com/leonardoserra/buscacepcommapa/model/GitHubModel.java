...
public class GitHubModel {
    ...
    public GitHubModel(MainViewModel viewModel, Context contextoPassado) {
            ...
            public void onResponse(Response<MapsGoogle> response) {
                ...
                if (model == null) {
                    ...
                    if (addressComponent.get(1).types != null
                        ...
                        viewModel.setBairro(addressComponent.get(1).long_name);
                        viewModel.setCidade(addressComponent.get(2).long_name);
                        viewModel.setUf(addressComponent.get(3).short_name);
                    }
                    if (addressComponent.get(2).types != null
                        ...
                        viewModel.setBairro(addressComponent.get(2).long_name);
                        viewModel.setCidade(addressComponent.get(3).long_name);
                        viewModel.setUf(addressComponent.get(4).short_name);
                    }
                    viewModel.setLat(result.geometry.location.lat);
                    viewModel.setLng(result.geometry.location.lng);
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == null)
                ...
                try {
                    ...
                    viewModel.setCep(cep);
                    viewModel.setLogradouro(logradouro);
